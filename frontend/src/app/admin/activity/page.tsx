...
import { auditApi, adminApi, AuditLogEntry, AdminUser } from '@/lib/api';
...
const ACTION_OPTIONS = [
  ...
  { value: 'file.version.create', label: 'New Version' },
...
export default function AdminActivityPage() {
  ...
  }, [mounted, accessToken, user?.isAdmin]);

  const loadUsers = async () => {
    try {
      const result = await adminApi.listUsers(1, 100);
  ...
  const loadActivities = async () => {
    ...
    setError(null);
    try {
      const data = await auditApi.getAllActivity({
        limit: 100,
  ...
  }, [selectedUserId, selectedAction, startDate, endDate]);
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">View all user activities</p>
            </div>
          </div>
      ...
      <main className="max-w-6xl mx-auto p-6">
        {loading ? (
          ...
          <div className="text-center py-24">
            ...
            <h2 className="text-lg font-semibold text-gray-600">No activity found</h2>
